...
;            (person-image (make-person "abc" "xyz" 21 2 65)) -> image of person with twice the unit height
...
; TEST
(person-image (make-person "Isha" "Shah" 21 1 45))
(person-image (make-person "abc" "xyz" 21 2 65))